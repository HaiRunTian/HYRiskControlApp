...
import tianchi.com.risksourcecontrol.activitiy.message.ReplyNoticeActivity;
...
//                                _unReadDatas.get(i).setRead(1);
                        ...
                        MyToast.showMyToast(CheckedListActivity.this, "共有" + m_list.size() + "条通知", Toast.LENGTH_SHORT);
