...
import tianchi.com.risksourcecontrol.bean.newnotice.VerityfReplyNotify;
 ...
 * 监理或者业主 施工方 查看通知整改回复类 并且审批  17 19 20
 * 1.监理身份：读取信息，审核：通过，则显示通过印章，转发给业主，修改信息状态，转告给施工单位，
 * 2.业主身份，读取信息，显示业主审核通过的印章，审核：通过，显示业主审核印章，转告给监理和施工单位整改通知已经通过了，未通过，驳回整改通知，令施工单位重新整改
 */

public class SeeReplyInfoActivity extends BaseActivity implements View.OnClickListener, ILoadingNotifyView {
...
//                    break;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_danger_reform_reply_read);
        initView();
        initEvent();
        initValue();
    }
            ...
            QueryUserListWork.queryUserInfo(userRealName, new OnUserListListener() {
                ...
                public void onQuerySucceed(UserInfo userInfo) {
                    ...
                    if (pictureName != null && pictureName.length() > 0) {
                        ...
                        MyToast.showMyToast(SeeReplyInfoActivity.this, "该日志无照片", Toast.LENGTH_SHORT);
                ...
                public void onQueryFailed(String msg) {
                    MyToast.showMyToast(SeeReplyInfoActivity.this, msg, Toast.LENGTH_SHORT);
                }
            });
        }
            ...
            try {
                ...
                OkHttpUtils.postAsync(ServerConfig.URL_UPDATE_NOTIFY_STATE_REPLY, str, new OkHttpUtils.InsertDataCallBack() {
                    ...
                    public void requestFailure(Request request, IOException e) {
                        MyToast.showMyToast(SeeReplyInfoActivity.this, "失败", Toast.LENGTH_SHORT);
                    }
                    @Override
...
//        if (UserSingleton.getUserRoid() == 17 || UserSingleton.getUserRoid() == 20){
            ...
            m_btnPass.setVisibility(View.GONE);
            m_btnReject.setVisibility(View.GONE);
            m_edtOpinion.setVisibility(View.GONE);
...
//        LogUtils.i("审批传数据", json);
        OkHttpUtils.postAsync(ServerConfig.URL_SUBMIT_SUPERVISOR, json, new OkHttpUtils.InsertDataCallBack() {
            @Override
            public void requestFailure(Request request, IOException e) {
                MyToast.showMyToast(SeeReplyInfoActivity.this, "提交失败", Toast.LENGTH_SHORT);
            }
