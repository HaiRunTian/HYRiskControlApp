...
import tianchi.com.risksourcecontrol.factory.SafetyLogFactory;
import tianchi.com.risksourcecontrol.model.INewLogBiz;
import tianchi.com.risksourcecontrol.model.NewSafetyLogBiz;
...
public class NewSafetyLogPresenter implements INewLogPresenter {
    ...
    private SafetyLogInfo getSafetyLog() {
        ...
        _safetyLog.setTechnoDetails(m_newSafetyLogView.getTDetails());
        return _safetyLog;
    }
}
