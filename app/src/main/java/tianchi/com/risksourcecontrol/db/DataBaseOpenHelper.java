package tianchi.com.risksourcecontrol.db;
...
public class DataBaseOpenHelper extends SQLiteOpenHelper {
    ...
    public DataBaseOpenHelper(Context context, String dbName, int dbVersion, List<String> tableSqls) {
     ...
     * @author lihy
     */
    public static void init(Context context, String dbName, int dbVersion, List<String> tableSqls) {
    ...
    /**
     * @param @param sql
     * @param @param bindArgs args:new Object[]{"测试数据", 4}
     * @return void
     * @Title: execSQL
     * @Description: Sql写入
     * @author lihy
