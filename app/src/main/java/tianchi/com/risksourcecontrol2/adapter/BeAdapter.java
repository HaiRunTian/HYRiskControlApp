...
public class BeAdapter extends BaseAdapter {
    private Context m_context;
    private LayoutInflater m_inflater;
    private String[] m_string;
    private OnItemClickListener mOnItemClickListener;

    public BeAdapter(Context context, String[] m_string)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mOnItemClickListener.onBeClicked(position);
            }
        });
        return convertView;
    }
    ...
    public void setOnBeClickListener(OnItemClickListener onItemClickListener)
    {
