...
public class OwnerListviewAdatper extends BaseAdapter {
    // 填充数据的list
    ...
    // 构造器
    public OwnerListviewAdatper(List<String> list, Context context) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        OwnerListviewAdatper.isSelected = isSelected;
    }
