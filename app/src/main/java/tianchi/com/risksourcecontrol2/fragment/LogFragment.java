...
import tianchi.com.risksourcecontrol2.activitiy.log.QueryPatrolLogActivity;
import tianchi.com.risksourcecontrol2.activitiy.log.QuerySafetyLogActivity;
import tianchi.com.risksourcecontrol2.adapter.MyExpandableListAdapter;
...
//    private String[] m_groups = {"生产日志上报与管理", "重大风险源巡查日志"};
    private String[] m_groups = {"重大风险源巡查日志", "生产安全日志"};
...
//            {"新建重大风险源日志", "重大风险源日志浏览"}};
    ...
    private String[][] m_childs = {{"新建重大风险源日志", "重大风险源日志浏览"}, {"新建安全日志", "安全日志浏览"}};
...
//                    R.mipmap.ic_safety_manufacture_broswe_32px},};
    private int[][] m_imgIds = {
            {R.mipmap.ic_safety_manufacture_new_32px,
                    R.mipmap.ic_safety_manufacture_broswe_32px}, {R.mipmap.ic_safety_manufacture_new_32px,
            R.mipmap.ic_safety_manufacture_broswe_32px}};
