...
//        LogUtils.i("_imgInfo", m_imgInfo +"");
        ...
        //如果如果接收人不是整改人（即抄送人或者监理，隐藏回复）
        if (!_firstName.equals(UserSingleton.getUserInfo().getRealName()))
            ...
            QueryUserListWork.queryUserInfo(userRealName, new OnUserListListener() {
                ...
                public void onQuerySucceed(UserInfo userInfo) {
                    ...
                    if (pictureName != null && pictureName.length() > 0) {
                        ...
                        MyToast.showMyToast(ReadRectifyNotifyInfoActivity.this, "该日志无照片", Toast.LENGTH_SHORT);
                ...
                public void onQueryFailed(String msg) {
                    MyToast.showMyToast(ReadRectifyNotifyInfoActivity.this, msg, Toast.LENGTH_SHORT);
                }
            });
        }
    }
