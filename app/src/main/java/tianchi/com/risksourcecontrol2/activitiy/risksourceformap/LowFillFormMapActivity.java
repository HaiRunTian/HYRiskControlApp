...
/**
 * Created by HaiRun on 2018-09-29 17:17.
 * 低填浅埋
 */

public class LowFillFormMapActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText m_edtsoilHeight; //取土高度
    private EditText edtLength; //长度
    private EditText edtWidth; //处理宽度
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_low_fill);
    ...
    private void initView() {
        ...
        m_edtsoilHeight = $(R.id.edtgetsoilheight);
        edtLength = $(R.id.edtLength);
        edtWidth = $(R.id.edtwidth);
        edtWay = $(R.id.edtway);
    ...
    private void initData() {
        ...
        m_edtStakeNum.setText(m_bundle.getString("C_pileNo") + "");
        m_edtGrade.setText(m_bundle.getString("C_scope") + "");
        String color = m_bundle.getString("C_colorNote");
        switch (color) {
            case "1":
                colorName = "蓝色";
                break;
        ...
        m_edtPosibilityLevel.setText(m_bundle.getString("C_resultGrade") + "");
        m_edtSeriousesLevel.setText(m_bundle.getString("C_resultGrade") + "");
        m_edtType.setText(m_bundle.getString("C_type") + "");
        m_edtsoilHeight.setText(m_bundle.getString("C_soilHeight") + "");
        edtLength.setText(m_bundle.getString("C_length") + "");
        edtWidth.setText(m_bundle.getString("C_width") + "");
        edtWay.setText(m_bundle.getString("C_way") + "");
    }
                ...
                QueryLogForMapUtils.getSafetyLog(riskIndex, new OnQueryRiskListener() {
                    ...
                    public void onQuerySucceed(String string) {
                        ...
                        if (statue == -2) {
                            ...
                            MyToast.showMyToast(LowFillFormMapActivity.this, _msg, Toast.LENGTH_SHORT);

                        } else if (statue == 0) {

                            MyToast.showMyToast(LowFillFormMapActivity.this, "此风险源没有日志", Toast.LENGTH_SHORT);
...
//
                                    ...
                                    try {
                                        ...
                                        if (_safetyLogInfo != null) {
                                            ...
                                            _intent = new Intent(LowFillFormMapActivity.this, SafetyLogInfoActivity.class);
                                            _intent.putExtra("logInfo", _safetyLogInfo);
                                            startActivity(_intent);

                                        } else {
                                            MyToast.showMyToast(LowFillFormMapActivity.this, "没有查询到日志", Toast.LENGTH_SHORT);
                                        }
