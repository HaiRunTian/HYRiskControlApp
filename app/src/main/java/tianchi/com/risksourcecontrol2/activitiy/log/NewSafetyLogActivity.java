...
import tianchi.com.risksourcecontrol2.presenter.NewSafetyLogPresenter;
...
//                    m_picIndex = uploadImgIndex;
                    m_safetyLogPresenter.uploadFile(picFiles.size(), uploadImgIndex);
//                    picNames.set(i, "");
//                    break;
                }
//            } else {
...
//                        picBitmap = BitmapFactory.decodeFile(imgpath);//拍摄返回的bitmap
                        picBitmap = CameraUtils.getimage(imgpath);//拍摄返回的bitmap
                        if (picBitmap != null) {
